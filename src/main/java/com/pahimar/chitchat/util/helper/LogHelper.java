package com.pahimar.chitchat.util.helper;
...
public class LogHelper {
    ...
    public static final Marker MOD_MARKER = MarkerManager.getMarker(ChitChat.MOD_ID);
    private static final Logger LOGGER = LogManager.getLogger(ChitChat.MOD_ID);
